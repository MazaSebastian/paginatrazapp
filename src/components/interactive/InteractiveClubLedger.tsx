    ...
    <div className="w-full max-w-6xl mx-auto rounded-3xl bg-[#090e18]/90 border border-emerald-500/20 backdrop-blur-2xl shadow-[0_25px_60px_rgba(0,0,0,0.8),0_0_35px_rgba(16,185,129,0.12)] p-4 sm:p-7 text-white relative overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center text-center gap-3 pb-6 border-b border-white/[0.08]">
        ...
        <button
          ...
          className="px-3.5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold flex items-center justify-center gap-2 transition-all shadow-md shadow-emerald-600/20 cursor-pointer shrink-0 mx-auto"
        >
      ...
      {exportNotice && (
        <motion.div
          ...
          className="mt-4 p-3 rounded-xl bg-emerald-500/20 border border-emerald-500/40 text-emerald-200 text-xs flex flex-col sm:flex-row items-center justify-between text-center sm:text-left gap-2"
        >
          <div className="flex items-center justify-center gap-2">
          ...
          <span className="text-[11px] font-mono text-emerald-300 shrink-0">Descarga lista</span>
        </motion.div>
      )}

      {/* Metrics Row */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4 my-6">
        <div className="p-4 rounded-2xl bg-[#0f172a]/70 border border-white/[0.08] flex flex-col items-center justify-center text-center">
          <div className="flex items-center justify-center gap-1.5 text-slate-400 text-xs mb-1 w-full text-center">
            <span>Socios Activos</span>
            <Users className="w-4 h-4 text-emerald-400" />
          </div>
          <div className="text-2xl sm:text-3xl font-black font-mono text-white text-center">84 / 100</div>
          <div className="text-[11px] text-emerald-400 mt-1 text-center">84% de ocupación de cupo</div>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-[#0f172a]/70 border border-white/[0.08] flex flex-col items-center justify-center text-center">
          ...
          <div className="text-2xl sm:text-3xl font-black font-mono text-white text-center">$4.820.000</div>
          <div className="text-[11px] text-teal-300 mt-1 text-center">94% recaudación al día</div>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-[#0f172a]/70 border border-white/[0.08] flex flex-col items-center justify-center text-center">
          ...
          <div className="text-2xl sm:text-3xl font-black font-mono text-white text-center">$680 <span className="text-xs font-normal text-slate-400">/ g</span></div>
          <div className="text-[11px] text-cyan-300 mt-1 text-center">-14% vs trimestre anterior</div>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-[#0f172a]/70 border border-white/[0.08] flex flex-col items-center justify-center text-center">
          ...
          <div className="text-2xl sm:text-3xl font-black font-mono text-white text-center">8.450 <span className="text-xs font-normal text-slate-400">g</span></div>
          <div className="text-[11px] text-amber-300 mt-1 text-center">3 lotes curados disponibles</div>
        </div>
      </div>

      {/* Tabs Selector */}
      <div className="flex flex-wrap items-center justify-center gap-2 border-b border-white/[0.08] pb-3 mb-4">
        <button
      ...
      {activeTab === 'members' ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-5 rounded-2xl bg-[#0f172a]/60 border border-white/[0.06] text-center">
          <div className="p-4 rounded-xl bg-black/30 border border-white/[0.04] space-y-2 flex flex-col items-center justify-center text-center">
            <span className="text-xs text-slate-400 uppercase font-mono text-center">Energía & Climatización</span>
            <div className="text-xl font-bold font-mono text-white text-center">$280 <span className="text-xs font-normal text-slate-400">/ g (41%)</span></div>
          ...
          <div className="p-4 rounded-xl bg-black/30 border border-white/[0.04] space-y-2 flex flex-col items-center justify-center text-center">
            <span className="text-xs text-slate-400 uppercase font-mono text-center">Insumos & Bio-Nutrición</span>
            <div className="text-xl font-bold font-mono text-white text-center">$190 <span className="text-xs font-normal text-slate-400">/ g (28%)</span></div>
            <p className="text-[11px] text-slate-300 text-center">
          ...
          <div className="p-4 rounded-xl bg-black/30 border border-white/[0.04] space-y-2 flex flex-col items-center justify-center text-center">
            <span className="text-xs text-slate-400 uppercase font-mono text-center">Personal & Agronomía</span>
            <div className="text-xl font-bold font-mono text-white text-center">$210 <span className="text-xs font-normal text-slate-400">/ g (31%)</span></div>
            <p className="text-[11px] text-slate-300 text-center">
