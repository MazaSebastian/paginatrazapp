      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-zinc-600">
            © {new Date().getFullYear()} GrowAPP. Todos los derechos reservados.
          </p>
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((social) => (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-zinc-500 hover:text-emerald-400 hover:bg-white/10 transition-colors"
              >
