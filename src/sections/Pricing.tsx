...
const plans = [
  {
    ...
    popular: false,
    features: [
      { text: 'Hasta 50 plantas', included: true },
      { text: 'Integración IoT básica', included: true },
      { text: 'Acceso a app móvil', included: true },
      { text: 'Análisis de crecimiento', included: true },
      { text: 'Reportes PDF', included: true },
      { text: 'Soporte por email', included: true },
      { text: 'Acceso multiusuario', included: false },
      { text: 'Insights avanzados de IA', included: false },
      { text: 'Cumplimiento REPROCANN', included: false },
      { text: 'Auditoría legal', included: false },
    ],
  ...
  },
  {
    ...
    popular: true,
    features: [
      { text: 'Plantas ilimitadas', included: true },
      { text: 'Integración IoT completa', included: true },
      { text: 'Acceso web y móvil', included: true },
      { text: 'Análisis avanzado', included: true },
      { text: 'Reportes PDF personalizados', included: true },
      { text: 'Soporte prioritario', included: true },
      { text: 'Hasta 10 miembros', included: true },
      { text: 'Insights y predicciones IA', included: true },
      { text: 'Cumplimiento REPROCANN', included: false },
      { text: 'Auditoría legal', included: false },
    ],
    cta: 'Iniciar Prueba Gratis',
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Suite IoT empresarial', included: true },
      { text: 'Opciones white-label', included: true },
      { text: 'Integraciones personalizadas', included: true },
      { text: 'Reportes de cumplimiento auto', included: true },
      { text: 'Soporte dedicado 24/7', included: true },
      { text: 'Miembros de equipo ilimitados', included: true },
      { text: 'Acceso completo al asistente IA', included: true },
      { text: 'Cumplimiento REPROCANN', included: true },
      { text: 'Trazabilidad legal', included: true },
    ],
          ...
          <div className={`glass p-6 ${plan.popular ? 'pt-14' : ''} relative overflow-hidden`}>
            ...
            <div className="mb-6 relative z-10">
              ...
              {isYearly && (
                ...
                >
                  Ahorra ${plan.monthlyPrice * 12 - plan.yearlyPrice}/año
                </motion.p>
              )}
            </div>
